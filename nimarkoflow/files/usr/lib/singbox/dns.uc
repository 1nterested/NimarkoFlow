...
const DNS_FAILOVER_STATE_FILE = getenv("NIMARKOFLOW_DNS_FAILOVER_STATE_FILE") || "/var/run/nimarkoflow/dns-failover.json";
const DNS_HEALTH_ADDRESS = getenv("NIMARKOFLOW_DNS_HEALTH_ADDRESS") || "127.0.0.42";
const DNS_HEALTH_PORT_BASE = int(getenv("NIMARKOFLOW_DNS_HEALTH_PORT_BASE") || "10053");
