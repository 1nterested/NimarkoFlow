...
const PRIORITY_PID_FILE = getenv("NIMARKOFLOW_PRIORITY_PID_FILE") || RUNTIME_STATE_DIR + "/priority.pid";
const PRIORITY_UC = getenv("NIMARKOFLOW_PRIORITY_UC") || LIB_DIR + "/singbox/priority.uc";
const DIAGNOSTICS_UC = getenv("NIMARKOFLOW_DIAGNOSTICS_UC") || LIB_DIR + "/diagnostics/runtime.uc";
...
function log_message(message, level) {
    ...
    command_success_from_args([ "logger", "-t", "nimarkoflow", "[" + level + "] priority: " + as_string(message) ]);
}
